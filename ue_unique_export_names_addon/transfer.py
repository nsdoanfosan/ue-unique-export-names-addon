...
def export_detail_lines_for_object(obj):
    ...
    return [
        ...
        "Generated mesh: evaluated cards are joined per export asset; UV0 is the card UV, UV1 carries SystemColor.RG, UV2 carries packed Random+Depth/Factor, and UV3 carries AO/SystemColor.B for Skeletal Nanite. SystemColor Alpha is ignored.",
